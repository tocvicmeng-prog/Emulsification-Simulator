@echo off
REM ---------------------------------------------------------------------
REM EmulSim 9.2.0 -- Launch the Streamlit web UI (self-healing, diag-safe)
...
:launch
echo [EmulSim 9.2.0] Starting the web UI. Your default browser should open
...
:setup
echo [EmulSim 9.2.0] Virtual environment not found at:
echo                 %CD%\.venv
echo.
