@echo off
REM ---------------------------------------------------------------------
REM EmulSim 9.1.2 -- Launch the Streamlit web UI (self-healing, diag-safe)
...
:launch
echo [EmulSim 9.1.2] Starting the web UI. Your default browser should open
...
:setup
echo [EmulSim 9.1.2] Virtual environment not found at:
echo                 %CD%\.venv
echo.
