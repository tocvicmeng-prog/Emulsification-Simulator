# EmulSim 9.0.0 — Windows 11 x64 Installation Guide
...
```
[EmulSim 9.0.0] Launching web UI at http://localhost:8501
```
...
`EmulSim-9.0.0-Windows-x64` folder. No other files are touched.
...
EmulSim 9.0.0 requires Python 3.11 or newer. Install a supported
