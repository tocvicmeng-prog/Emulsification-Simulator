# EmulSim 9.1.2 — Windows 11 x64 Installation Guide
...
```
[EmulSim 9.1.2] Launching web UI at http://localhost:8501
```
...
`EmulSim-9.1.2-Windows-x64` folder. No other files are touched.
...
EmulSim 9.1.2 requires Python **3.11 or 3.12** (pinned by `requires-python =
