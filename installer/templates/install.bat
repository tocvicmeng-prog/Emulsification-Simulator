@echo off
REM ---------------------------------------------------------------------
REM EmulSim 9.1.1 -- Windows 11 x64 installer
REM
...
echo [EmulSim 9.1.1] Installer -- Windows 11 x64
...
echo.
echo =====================================================================
echo [install] DONE. EmulSim 9.1.1 is installed.
echo.
...
echo           Fix: uninstall, then re-install. v9.1.1 per-user install goes
