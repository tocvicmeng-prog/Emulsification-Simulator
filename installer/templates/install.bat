@echo off
REM ---------------------------------------------------------------------
REM EmulSim 9.2.2 -- Windows 11 x64 installer
REM
...
echo [EmulSim 9.2.2] Installer -- Windows 11 x64
...
echo.
echo =====================================================================
echo [install] DONE. EmulSim 9.2.2 is installed.
echo.
...
echo           Fix: uninstall, then re-install. v9.2.2 per-user install goes
