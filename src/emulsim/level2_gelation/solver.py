...
1D radial domain with semi-implicit Eyre time stepping.
Coupled with Avrami gelation kinetics for mobility arrest.
"""
...
from .spatial import create_radial_grid, build_laplacian_matrix
...
from .pore_analysis import characteristic_wavelength, chord_length_distribution, compute_porosity
